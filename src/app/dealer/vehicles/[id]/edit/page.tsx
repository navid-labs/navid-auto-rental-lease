...
export default async function DealerVehicleEditPage({ params }: Params) {
  ...
  if (!vehicle) notFound()
  if (vehicle.dealerId !== user.id) redirect('/dealer/vehicles')
  ...
  return (
    <div className="space-y-6">
      ...
      <VehicleWizard mode="edit" userRole="DEALER" initialData={initialData} />
    </div>
  )
}
