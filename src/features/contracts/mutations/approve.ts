...
export type ApproveContractResult = { success: true } | { error: string }

/**
 * Admin mutation to approve or reject a contract.
 * On approval: sets vehicle to RENTED/LEASED, sets start/end dates.
 * On rejection: restores vehicle to AVAILABLE.
 */
export async function approveContractMutation(
  contractId: string,
